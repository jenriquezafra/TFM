...
\begin{titlepage}
	...
	\begin{center}
		...
		\end{Large}
\todos{Revisar titulo para reflejar los cinco modelos finales: ANN baseline, ANN Sobolev, PINN baseline, PINN Sobolev y PINN Sobolev+ACV.}
...
\thispagestyle{plain}
\setcounter{page}{3}
	\todos{Reescribir el resumen con la nueva narrativa: eje principal ANN supervisada sobre IV; Sobolev mejora sobre todo griegas; PINN queda como alternativa no supervisada sobre precio con resultados razonables pero mas fragiles.}
	...
	\todos{Actualizar keywords para mencionar de forma consistente ANN baseline, ANN Sobolev, PINN baseline, PINN Sobolev y PINN Sobolev+ACV.}
