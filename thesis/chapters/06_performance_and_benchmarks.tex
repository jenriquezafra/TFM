...
The signed residuals over the \((m,\tau)\) quote grid are balanced around zero for the reference no-regularization solution, with no strong systematic bias. Localized positive and negative deviations remain in the same \(10^{-4}\) scale reported in Table~\ref{tab:cann_residual_distribution}.
