...
The second contribution is the improved neural calibration result. The final tanh CaNN run preserves the basic Liu-style calibration idea, but obtains a stronger inverse fit on the benchmark quote set. The improvement appears both in quote-level IV residuals and in parameter recovery, which is the relevant quantity for a calibration workflow.
