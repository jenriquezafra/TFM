...
\setbeamertemplate{footline}{%
  \leavevmode%
  \hbox{%
    \begin{beamercolorbox}[wd=.72\paperwidth,ht=2.5ex,dp=1.2ex,leftskip=8mm]{author in head/foot}%
      \color{gray45}\insertshorttitle
    \end{beamercolorbox}%
    \begin{beamercolorbox}[wd=.28\paperwidth,ht=2.5ex,dp=1.2ex,rightskip=8mm plus1fil]{date in head/foot}%
...
\institute[UC3M]{Master Degree in Applied and Computational Mathematics\\Universidad Carlos III de Madrid\\[2mm]Tutors: Jorge Morón Vidal and Francisco Manuel Bernal Martínez}
\date{Madrid, 2026}
...
\begin{tikzpicture}[
  ...
  \draw[greekline] (refs.south) -- (6.0,-0.78);
  \draw[greekline, -{Latex[length=2.1mm,width=1.5mm]}, opacity=#1] (6.0,-0.78) -- (annsobo.north);
  \draw[greekline, opacity=#2] (6.0,-0.78) -- (6.0,-2.28);
  \draw[greekline, -{Latex[length=2.1mm,width=1.5mm]}, opacity=#2] (6.0,-2.28) -- (pinnsobo.north);
\end{tikzpicture}%
}
