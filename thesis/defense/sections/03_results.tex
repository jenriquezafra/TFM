...
\begin{frame}{ANN baseline: IV surrogate}
...
\begin{frame}{ANN Sobolev: Greek error distributions}
  \centering
...
\begin{frame}{ANN Sobolev: Greek error maps}
  \centering
...
\begin{frame}{PINN baseline pricing}
  \begin{columns}[T,onlytextwidth]
...
\begin{frame}{PINN Sobolev: pricing--Greek trade-off}
  \centering
  \small
  \begin{tabular}{lccc}
    \toprule
...
\begin{frame}{PINN Sobolev: Greek error maps}
  \centering
...
\begin{frame}{Sobolev+ACV: local hard-region correction}
  \centering
...
\begin{frame}{Evaluations per second}
  \centering
  \begin{tabular}{lrr}
    \toprule
